...
On Nvidia consumer Pascal (GTX 10xx, not P100, and not Volta), Turing, and Ampere GPUs, int8 models (see https://github.com/BobJohnson24/ComfyUI-INT8-Fast and https://github.com/Comfy-Org/comfy-kitchen/pull/37 ) are preferable to fp8 models, which actually reduce the compute time with faster int8 matmul than fp16.
